...
import (
	...
	"github.com/Kuber-2024-10OTUS/perovmpr_repo/kubernetes-operators/operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(otusv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "4fbf87a6.homework",
